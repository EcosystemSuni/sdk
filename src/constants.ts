...
export const INIT_CODE_HASH: string = '0xdf2db5b9541ad52bdd9f49e5ecb0f1258e5970a95cbce16fc52a5be0e382b5e1'

export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x27C0dF6b874f0768B687C95367b826D9948fa086',
  [ChainId.ROPSTEN]: '0xc35DADB65012eC5796536bD9864eD8773aBc74C4',
  [ChainId.RINKEBY]: '0x94bA934C039ca479799766fae4210D16A4573600',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x2A4ac3e112d43e8B8d1d59a0Ef57653C56eBC0b8',
  [ChainId.RINKEBY]: '0x62ECC4dc428C1E4eAf02639948271f28bFf9FC35',
...
export const SUSHI_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x3A49360098cF9061630211874398EC75704C0595',
  [ChainId.ROPSTEN]: '0x0769fd68dFb93167989C6f7254cd0D766Fb2841F',
  [ChainId.RINKEBY]: '0xdaDd70dcCb18DA172751E382E40D594929FE3067',
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x557691633CFf6ad68393b33051Cb25b3194d336B',
  [ChainId.ROPSTEN]: '0x80C7DD17B01855a6D2347444a0FCC36136a314de',
  [ChainId.RINKEBY]: '0x0B16D55c8245dC36fA60f3AcE1C36c12704DE02f',
...
export const BAR_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x065C13f1999827824dcc255049e815D8eb75769A',
  [ChainId.ROPSTEN]: '0x1be211D8DA40BC0ae8719c6663307Bfc987b1d6c',
  [ChainId.RINKEBY]: '0xE8A7Cd59aAa09A31aF9C61E9C6Da8d68A81cC198',
...
export const MAKER_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x6520E26B611828B59112094655D44dDFa33b0c6f',
  [ChainId.ROPSTEN]: '0x1b9d177CcdeA3c79B6c8F40761fc8Dc9d0500EAa',
  [ChainId.RINKEBY]: '0x4A921888cD77b5951390bc084F8dcBb3C1c3695A',
